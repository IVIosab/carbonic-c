...
RELATION: 
    SIMPLE {}|
    SIMPLE TK_CEQ SIMPLE {}|
    SIMPLE TK_CNEQ SIMPLE {}|
    SIMPLE TK_CGE SIMPLE {}|
    SIMPLE TK_CGT SIMPLE {}|
    SIMPLE TK_CLT SIMPLE {}|
    SIMPLE TK_CLE SIMPLE {}|
    SIMPLE TK_NOT SIMPLE {}
    ;
SIMPLE:
    FACTOR {}|
...
VARIABLE_DECLERATIONS: 
    ...
    ;
ASSIGNMENT: 
TK_IDENTIFIER TK_ASSIGN EXPRESSION TK_SCOLON {};
IF_STATEMENT: 
